...
export default function Container(props: any) {
  ...
  const isBlogSlug = router.asPath.startsWith("/blog/");
    ...
    <div className="w-full">
      {!isBlogSlug && (
        <Head>
          ...
          <link
            rel="canonical"
            href={`https://melvinliu.com${router.asPath}`}
          />
      ...
      <div
        className={cn(
          ...
          "dark:bg-darkBlack sticky top-0 z-50 px-4 md:px-8 xl:px-24 2xl:px-48 mb-4"
        )}
      >
      ...
      <main className=" flex flex-col justify-center mt-2 md:mt-8 pt-2 md:pt-4 px-4 md:px-8 xl:px-24 2xl:px-48">
        {children}
        <Footer />
      </main>
    </div>
